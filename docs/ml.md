...
Это позволяет обучать все 10 тикеров на сервере с ограниченной оперативной памятью.
...
```
========================================================
  [1/10] SBER  (7164 строки)
========================================================
    LightGBM HPO   [####################]  50/50 | best F1=0.4049
    ExtraTrees HPO [####################]  50/50 | best F1=0.3978
  > Отбор признаков (проход 1 из 2, порог >=0.01)... ok  32 из 52 признаков (-20)
  > CV оценка ансамбля... ok  F1=0.4049
